...
def topology(): 
 ...
 info("*** Creating nodes")
 c1 = net.RemoteController( 'c1', ip='192.168.0.1', port=3001)
 ...
 h1 = net.addHost( 'h1', mac='00:00:00:00:00:03', ip='192.168.12.33/5') 
 h2 = net.addHost( 'h2', mac='00:00:00:00:00:04', ip='192.168.0.4/5') 
